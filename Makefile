...
mpssc_trails.4326.short_names.csv: mpssc_trails2013/mpssc_trails2013a.shp
...
summit_trailheads.csv: mpssc_trailheads.csv cvnp_trailheads.csv
	ruby csv_trailhead_filter.rb

cvnp_trailheads.csv: CUVA_CFA.gdb
	rm -f cvnp_trailheads.csv
	ogr2ogr -f "CSV" \ 
	-s_srs EPSG:3857 -t_srs EPSG:4326 \
	cvnp_trailheads.csv \
	~/CUVA_CFA.gdb TF_TrailHead \
	-lco GEOMETRY=AS_WKT

summit_traildata.csv: mpssc_traildata.csv cvnp_traildata.csv
	cat mpssc_traildata.csv cvnp_traildata.csv > summit_traildata.csv