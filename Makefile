...
mpssc_trails.4326.csv: mpssc_trails2013/mpssc_trails2013a.shp
	rm -f mpssc_trails.4326.csv # ogr2ogr can't seem to overwrite this file
	ogr2ogr -f "CSV" -nlt MULTILINESTRING \
